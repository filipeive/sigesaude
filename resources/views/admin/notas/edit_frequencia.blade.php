...
@section('title', 'Editar Notas de Frequência')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-edit mr-2"></i> Notas de Frequência</h1>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-list mr-1"></i> Lista de Alunos</h3>
        </div>
            ...
            <table class="table table-hover table-bordered">
                <thead class="thead-primary">
                    <tr>
                        ...
                        <th>Nome</th>
                        <th>Matrícula</th>
                        <th style="width:180px;text-align:center;">Nota Freq. Atual</th>
                ...
                @forelse($alunos as $idx => $aluno)
                    @php $nota = $aluno->notasFrequencia->first(); @endphp
                    <tr>
                        <td>{{ $idx + 1 }}</td>
                        ...
                        <td style="text-align:center;">
                            <form method="POST" action="{{ route('admin.notas.update_frequencia', $nota?->id ?? 'novo') }}" style="display:inline-flex;">
                                @csrf @method('PUT')
                        ...
                        <td style="text-align:center;">
                            <button type="submit" formmethod="POST" formaction="{{ $nota ? route('admin.notas.update_frequencia', $nota) : '#' }}"
