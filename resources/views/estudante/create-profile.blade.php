                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('estudante.store.profile') }}">
                            ...
                            <div class="form-group row mb-3">
                                <label for="matricula" class="col-md-4 col-form-label text-md-right">Número de
                                    Matrícula</label>
                                <div class="col-md-6">
                                    <input id="matricula" type="text"
                                        class="form-control @error('matricula') is-invalid @enderror" name="matricula"
                                        value="{{ $matricula }}" readonly>
                                    <small class="form-text text-muted">
                                        Este número de matrícula é gerado automaticamente pelo sistema
                                    </small>
                                    @error('matricula')
                            ...
                            <div class="form-group row mb-3">
                                <label for="ano_lectivo_id" class="col-md-4 col-form-label text-md-right">Ano
                                    Lectivo</label>

                                <div class="col-md-6">
                                    <select id="ano_lectivo_id"
                                        class="form-control @error('ano_lectivo_id') is-invalid @enderror"
                                        name="ano_lectivo_id" required>
                                        <option value="">Selecione um ano lectivo</option>
                                        @foreach ($anosLectivos as $anoLectivo)
                                            <option value="{{ $anoLectivo->id }}"
                                                {{ old('ano_lectivo_id') == $anoLectivo->id ? 'selected' : '' }}>
                                                {{ $anoLectivo->ano }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row mb-3">
                                <label for="ano_ingresso" class="col-md-4 col-form-label text-md-right">Ano de
                                    Ingresso</label>

                                <div class="col-md-6">
                                    <input id="ano_ingresso" type="number" min="2000" max="2099"
                                        step="1" class="form-control @error('ano_ingresso') is-invalid @enderror"
                                        name="ano_ingresso" value="{{ old('ano_ingresso', date('Y')) }}" required>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="turno" class="form-control @error('turno') is-invalid @enderror"
                                        name="turno" required>
                                        <option value="">Selecione</option>
                                        <option value="Diurno" {{ old('turno') == 'Diurno' ? 'selected' : '' }}>Diurno
                                        </option>
                                        <option value="Noturno" {{ old('turno') == 'Noturno' ? 'selected' : '' }}>Noturno
                                        </option>
                                    </select>
                            ...
                            <div class="form-group row mb-3">
                                <label for="contato_emergencia" class="col-md-4 col-form-label text-md-right">Contato de
                                    Emergência</label>

                                <div class="col-md-6">
                                    <input id="contato_emergencia" type="text"
                                        class="form-control @error('contato_emergencia') is-invalid @enderror"
                                        name="contato_emergencia" value="{{ old('contato_emergencia') }}">
