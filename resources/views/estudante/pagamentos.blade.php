...
@section('content')
    <div class="container-fluid">
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="propinas" role="tabpanel">
                        <div class="row mb-4">
                            ...
                            <div class="alert alert-info">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p>Para proceder com o pagamento usando referências, dirija-se a qualquer ATM dos
                                            Bancos
                                            indicados, procure pela opção <strong>PAGAMENTOS</strong> e selecione depois a
                                            opção
                                            <strong>PAGAMENTO DE SERVIÇOS</strong>.
                                        </p>
                                        <p class="mb-0">Digite a <strong>ENTIDADE</strong>, <strong>REFERÊNCIA</strong> e
                                            o
                            ...
                            <!-- Dentro da tab Propinas, substitua a tabela atual por: -->
                            <div class="table-responsive">
                                <table id="propinasTable" class="table table-hover" style="width:100%">
                                        ...
                                        @foreach ($propinas as $propina)
                                            @php
                                                $isVencido =
                                                    ...
                                                    \Carbon\Carbon::parse($propina->data_vencimento)->isPast();
                                            @endphp
                                            <tr data-status="{{ $propina->status }}"
                                                data-vencido="{{ $isVencido ? 'sim' : 'nao' }}">
                                                <td>{{ Carbon\Carbon::parse($propina->data_vencimento)->format('F/Y') }}
                                                </td>
                                                <td
                                                    data-order="{{ \Carbon\Carbon::parse($propina->data_vencimento)->format('Y-m-d') }}">
                                                ...
                                                <td class="text-right" data-order="{{ $propina->valor }}">
                                                    {{ number_format($propina->valor, 2, ',', '.') }}
                                                </td>
                                                <td>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="periodo_filter"><i class="fas fa-calendar-week mr-1"></i>
                                            Período</label>
                                                    ...
                                                    <div id="collapseOne" class="collapse show"
                                                        ...
                                                        <div class="card-body">
                                                            <ol>
                                                                ...
                                                                <li>Escolha a opção "Pagamentos" > "Pagamento de Serviços"
                                                                </li>
                                                    ...
                                                    <div id="collapseTwo" class="collapse"
                                                        ...
                                                        <div class="card-body">
                                                            <ol>
                                                                ...
                                                                <li>Procure pela opção "Pagamentos" > "Pagamento de
                                                                    Serviços"
                                                                </li>
                                                                <li>Preencha os dados conforme sua ficha de pagamentos</li>
                                                                <li>Confirme e guarde o comprovante</li>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="card h-100">
                                                        <div class="card-body text-center">
                                                            <img src="{{ asset('img/banks/ponto24.png') }}"
                                                                alt="Ponto24" class="img-fluid mb-3"
                                    ...
                                    <div class="card mt-4">
                                        <div class="card-header bg-info text-white">
                                            <h3 class="card-title"><i class="fas fa-upload mr-2"></i> Enviar Comprovante
                                            </h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="{{ route('estudante.registrar.pagamento') }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    <label for="referencia"><i class="fas fa-hashtag mr-1"></i>
                                                        Referência</label>
                                                    <select class="form-control select2" id="referencia"
                                                ...
                                                <div class="form-group">
                                                    <label for="data_pagamento"><i class="fas fa-calendar-day mr-1"></i>
                                                        Data
                                                        do Pagamento</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small class="form-text text-muted">Formatos aceitos: PDF, JPG, PNG
                                                        (max.
                                                        5MB)</small>
                                                </div>
                                                <div class="form-group">
        ...
        @foreach ($propinas as $propina)
            @php
                $isVencido =
                    $propina->status == 'pendente' && \Carbon\Carbon::parse($propina->data_vencimento)->isPast();
            @endphp
                        ...
                        <div class="modal-body">
                                ...
                                <div class="col-md-6">
                                    <div class="info-box bg-light">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number">{{ number_format($propina->valor, 2, ',', '.') }}
                                                MZN</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mt-3">
                                <div class="card-header bg-light">
                                    <h5 class="card-title"><i class="fas fa-university mr-2"></i> Dados para Pagamento
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <ul class="nav nav-tabs nav-justified mb-4" id="paymentTabs{{ $propina->id }}"
                                role="tablist">
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="paymentTabsContent{{ $propina->id }}">
                                ...
                                <div class="tab-pane fade" id="upload{{ $propina->id }}">
                                    <form action="{{ route('estudante.registrar.pagamento') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <label for="metodo_pagamento"><i class="fas fa-credit-card mr-1"></i> Método
                                                de
                                                Pagamento</label>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-6">{{ number_format($propina->valor, 2, ',', '.') }} MZN
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6 font-weight-bold">Método:</div>
                                            <div class="col-6">
                                                {{ $propina->metodo_pagamento ?? 'Transferência Bancária' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    @section('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                // Filtro por status - agora com JavaScript puro
                $('#status_filter').on('change', function() {
                    var status = $(this).val();
                    var rows = $('#propinasTable tbody tr');

                    rows.each(function() {
                        var row = $(this);
                        var rowStatus = row.data('status');
                        var isVencido = row.data('vencido') === 'sim';
                        ...
                        // Aplicar filtros
                        if (status === 'pendente') {
                            if (rowStatus !== 'pendente') row.hide();
                        } else if (status === 'vencido') {
                            if (!isVencido) row.hide();
                        } else if (status === 'pago') {
                            if (rowStatus !== 'pago') row.hide();
                        }
                    });
                });
                ...
                $('#propinasTable tbody tr').each(function() {
                    if ($(this).data('vencido') === 'sim') {
                        $(this).addClass('table-danger');
                    }
                });

                // Tooltips para datas vencidas
                $('span.badge-danger:contains("Vencido")').each(function() {
                    var dataVencimento = $(this).closest('tr').find('td:eq(1)').data('order');
                    if (dataVencimento) {
                        var diasVencidos = moment(dataVencimento).fromNow();
                        $(this).attr('data-toggle', 'tooltip')
                            .attr('title', 'Vencido ' + diasVencidos)
                            .tooltip();
                    }
                });
            });

            // Funções globais (mantidas as mesmas)
            function mostrarDetalhesPagamento(id) {
                $('#detalhesModal' + id).modal('show');
            }

            function mostrarModalPagamento(id) {
                $('#pagarModal' + id).modal('show');
            }

            function mostrarRecibo(id) {
                $('#reciboModal' + id).modal('show');
            }

            function enviarComprovativo(formId) {
                var form = document.getElementById(formId);
                var formData = new FormData(form);

                Swal.fire({
                    title: 'Enviando comprovativo...',
                    html: 'Por favor aguarde enquanto processamos seu envio.',
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            text: 'Seu comprovativo foi enviado com sucesso e está em análise.',
                    ...
                    error: function(xhr) {
                        ...
                        var errorMessage = 'Ocorreu um erro ao enviar o comprovativo.';
