                ...
                <div class="tab-content" id="financialTabsContent">
                                            ...
                                            $rowClass =
                                                $propina->status == 'pago'
                                                    ...
                                                    : ($isVencido
                                                        ...
                                                        : 'bg-warning-light');
                                        @endphp
                                        <tr class="{{ $rowClass }} hover-shadow"
                                            data-status="{{ $propina->status }}"
                                        ...
                                        <tr>
                                            <td colspan="7" class="text-center py-5">
                                                <div class="empty-state">
                                                    ...
                                                    <p class="text-muted">Não há propinas pendentes para o período
                                                        selecionado.
                                                    </p>
                                                </div>
                                            </td>
                    ...
                    <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="download_report"><i
                                            class="fas fa-file-download mr-1"></i>Relatório:</label>
                                    <div class="input-group">
                                        ...
                                        <div class="timeline">
                                            ...
                                            <div>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-body">
                                                        <p>Apresente no balcão do banco a entidade, referência e valor de
                                                            cada
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-success text-white">
                                        <h5 class="m-0"><i class="fas fa-credit-card mr-2"></i>Redes Bancárias
                                            Disponíveis
                                        </h5>
                                    </div>
                                    <div class="card-body text-center">
                                        ...
                                        <div class="alert alert-warning shadow-sm">
                                            ...
                                            <strong>Importante:</strong> Utilize apenas as redes bancárias listadas acima
                                            para
                                            seus pagamentos.
                                        </div>
                                    </div>
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-header bg-info text-white">
                                        <h5 class="m-0"><i class="fas fa-upload mr-2"></i>Enviar Comprovante de
                                            Pagamento
                                        </h5>
                                    </div>
                                    <div class="card-body">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // 1. Inicialização de Tooltips
            const initTooltips = () => {
                $('[data-toggle="tooltip"]').tooltip(config.tooltip);
            };

            // 2. Clipboard (Copiar para área de transferência)
            const initClipboard = () => {
            ...
            // 3. Select2 com estilização avançada
            const initSelects = () => {
                $('.select2').each(function() {
                    const $select = $(this);

                    // Configurações específicas para cada select
                    ...
                    $select.select2(specificConfig)
                        .on('select2:open', () => {
                            // Ajustar z-index para ficar acima de modais
                ...
                // Select de ano letivo - submit automático
            ...
            const initFileUploads = () => {
                $(document).on('change', '.custom-file-input', function() {
                    ...
                    $(this).next('.custom-file-label')
                        .addClass("selected")
                        .html(fileName || "Escolher arquivo");
                });
            };
            ...
            const initTableFilters = () => {
                ...
                $('#status_filter').on('change', function() {
                    ...
                    if (status === 'todos') {
                        ...
                        $rows.hide().filter('[data-vencido="sim"]').show();
                    } else {
                ...
                // Busca na tabela
                $('#table_search').on('keyup', debounce(function() {
            ...
            // 6. Botões com efeito de loading
            const initActionButtons = () => {
                $(document).on('click', '.btn-action', function() {
                    const $btn = $(this);
                    $btn.prop('disabled', true)
                        .html('<i class="fas fa-spinner fa-spin mr-1"></i> Processando...');

                    // Reset após 5 segundos (apenas para demonstração)
                    setTimeout(() => {
                        $btn.prop('disabled', false)
                            .html($btn.data('original-text') || 'Concluído');
                    }, 5000);
                }).each(function() {
            ...
            // 7. Gráfico de pagamentos
            const initPaymentChart = () => {
                if ($('#paymentsChart').length) {
                    const ctx = $('#paymentsChart')[0].getContext('2d');
                    const paymentData = [
            ...
            // 8. Efeito de destaque para vencimentos próximos
            const initDueDateHighlight = () => {
                const hasDueDate = {{ $proximoVencimento ? 'true' : 'false' }};
                if (hasDueDate) {
                    setInterval(() => {
